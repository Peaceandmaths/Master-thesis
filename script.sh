...
echo "Predicting completed successfully" | mail -s "Predicting Status" golubeka@students.zhaw.ch
...
echo "Postprocessing completed successfully" | mail -s "Postprocessing Status" golubeka@students.zhaw.ch
...
echo "Evaluation completed successfully" | mail -s "Evaluation Status" golubeka@students.zhaw.ch
